...
- [x] Document the honest Vanta capability roadmap, including the future Python, Node, infrastructure, and data-system upgrades required for the complete product vision.
